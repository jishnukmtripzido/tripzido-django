...
SECRET_KEY = "ydf)aba#jrii=tync3o=i0pj(d+wyo*2g0p&1*6d$lf8wi6un4"
...
WHATSAPP_API_VERSION = env("WHATSAPP_API_VERSION", default="v26.0")
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.core.audit.AuditJWTAuthentication",
    ],
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="Tripzido <no-reply@tripzido.com>"
)
