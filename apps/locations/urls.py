...
from apps.locations.views import (
    ...
    PickupLocationListCreateView, PickupLocationDetailView,
)
...
urlpatterns = [
    ...
    path("pickup-locations/", PickupLocationListCreateView.as_view(), name="pickup-list"),
    path("pickup-locations/<int:pk>/", PickupLocationDetailView.as_view(), name="pickup-detail"),
]